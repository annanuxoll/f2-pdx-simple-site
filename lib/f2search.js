...
module.exports = function(searchText) {
  ...
  var findPhrase = function (phrase) {
     //  use split method on commas to make an array of search terms
     // then loop though the search terms, using notes.concat() to add 
     // to the notes when a match is found 
    var results = {
      lectures: [],
      labs: []
    };
    ...
    // if notes = [], set notes = "no results found"
    results =  { notes: notes };
